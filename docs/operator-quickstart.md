# Operator Quickstart — Activities of trade unions

Shortest path from clone to a verified local dry-run for **ISIC 9420** (`cloud-itonami-isic-9420`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-9420.git
cd cloud-itonami-isic-9420
```
...
- Blueprint governor key: `union-governance-governor`
- Likely source path: `union.governor.cljc`
